...
pytest.skip(
    "TorchRL integration pending - missing tensordict dependency",
...
def test_memory_sharing_sim_to_env(sim_manager):
    ...
    _sim_action = sim_manager.action_tensor().to_torch()
...
@pytest.mark.skip(
    reason="GPU env conflicts with gpu_manager fixture - Madrona doesn't support "
    "multiple GPU managers"
)
