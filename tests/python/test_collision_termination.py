...
class TestCollisionTermination:
    ...
    def test_east_collision_continues(self, collision_test_manager):
        ...
        for step in range(10):  # More steps to test continued simulation
            ...
            assert not observer.get_done_flag(0), f"Episode should continue after east wall collision at step {step}"
    ...
    def test_south_collision_continues(self, collision_test_manager):
        ...
        for step in range(10):  # More steps to test continued simulation
            ...
            # Episode should continue running even after collision
            assert not observer.get_done_flag(0), f"Episode should continue after south wall collision at step {step}"
