...
mcp = FastMCP(
    ...
    instructions="""Use this server for Madrona simulation tasks. This server provides Python execution with pre-loaded Madrona environment including SimManager, madrona, and numpy. Use when you need to:
...
async def list_variables() -> str:
    ...
    variables = {k: v for k, v in global_namespace.items() 
